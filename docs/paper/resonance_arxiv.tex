...
We validate internal consistency with 3{,}084 automated tests
...
\begin{enumerate}
  ...
  \item Six experimental validations: emergent molecular bonding,
        genome growth, chemotherapy resistance, pathway-level
        drug inhibition, combination therapy advantage
        (Bozic~2013 confirmed, 10/10 seeds), and adaptive
        therapy control (\cref{sec:experiments}).
...
14~tests verify calibration correctness.
...
$>10^6$ world-ticks per second with 3{,}084 automated tests.
