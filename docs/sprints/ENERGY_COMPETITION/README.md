...
|--------|---------|-----------------|------|--------------|--------|
| [EC-1](SPRINT_EC1_POOL_EQUATIONS.md) | Pool Equations | `src/blueprint/equations/energy_competition/` | 0 | — | ⏳ |
| [EC-2](SPRINT_EC2_POOL_COMPONENTS.md) | Pool Components | `src/layers/` | A | EC-1 | ⏳ |
| [EC-3](SPRINT_EC3_EXTRACTION_REGISTRY.md) | Extraction Registry | `src/blueprint/equations/energy_competition/` | A | EC-1 | ⏳ |
| [EC-4](SPRINT_EC4_POOL_DISTRIBUTION_SYSTEM.md) | Pool Distribution System | `src/simulation/metabolic/` | B | EC-2, EC-3 | ⏳ |
| [EC-5](SPRINT_EC5_COMPETITION_DYNAMICS.md) | Competition Dynamics | `src/blueprint/equations/energy_competition/` | C | EC-4 | ⏳ |
| [EC-6](SPRINT_EC6_CONSERVATION_LEDGER.md) | Conservation Ledger | `src/layers/`, `src/simulation/metabolic/` | C | EC-4 | ⏳ |
| [EC-7](SPRINT_EC7_SCALE_INVARIANT_COMPOSITION.md) | Scale-Invariant Composition | `src/blueprint/equations/energy_competition/`, `src/simulation/metabolic/` | D | EC-5, EC-6 | ⏳ |
| [EC-8](SPRINT_EC8_INTEGRATION_DEMO.md) | Integration Demo | `src/entities/`, `assets/maps/` | E | Todos | ⏳ |
