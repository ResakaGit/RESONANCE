...
pub use competition_arena::{COMPETITION_ARENA_SLUG, spawn_competition_demo_startup_system};
...
pub use inferred_world::{INFERRED_WORLD_SLUG, spawn_inferred_world_startup_system};
pub use morphogenesis_demo::{MORPHOGENESIS_DEMO_SLUG, spawn_morphogenesis_demo_startup_system};
