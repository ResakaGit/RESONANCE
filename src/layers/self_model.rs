...
impl Default for SelfModel {
    fn default() -> Self {
        Self { predicted_qe: 0.0, planning_horizon: 1, self_accuracy: 0.0, metacog_cost: 0.05 }
    }
}
...
mod tests {
    ...
    fn self_model_conscious_when_thresholds_met() {
        let m = SelfModel { predicted_qe: 0.0, planning_horizon: 200, self_accuracy: 0.9, metacog_cost: 0.05 };
        assert!(m.is_functionally_conscious());
    }
}
