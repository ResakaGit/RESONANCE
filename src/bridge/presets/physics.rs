...
const DENSITY_MOD: [BandDef; 5] = [
    ...
    BandDef { min: 60.0,  max: 100.0, canonical: 80.0,  stable: true },
    BandDef { min: 100.0, max: 500.0, canonical: 200.0, stable: true },
];
...
const TEMPERATURE_MOD: [BandDef; 5] = [
    ...
    BandDef { min: 200.0, max: 300.0, canonical: 250.0, stable: true },
    BandDef { min: 300.0, max: 400.0, canonical: 350.0, stable: true },
    BandDef { min: 400.0, max: 600.0, canonical: 500.0, stable: true },
];

const PHASE_MOD: [BandDef; 4] = [
    BandDef { min: 0.0,   max: 30.0,     canonical: 15.0,  stable: true },
    BandDef { min: 30.0,  max: 100.0,    canonical: 60.0,  stable: true },
    BandDef { min: 100.0, max: 300.0,    canonical: 180.0, stable: true },
    BandDef { min: 300.0, max: 10_000.0, canonical: 400.0, stable: true },
];
...
impl_bridge_defaults!(PhaseTransitionBridge, "phase_transition", PHASE_MOD,       5.0, 70);
