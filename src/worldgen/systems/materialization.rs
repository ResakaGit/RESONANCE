//! Mutación de worldgen en runtime: delta de materialización, seasons graduales, eventos.
...
use super::startup::StartupNucleus;
...
use crate::worldgen::{
    BoundaryVisual, EnergyFieldGrid, EnergyNucleus, EnergyVisual, Materialized,
    PendingEnergyVisualRebuild, PhenologyPhaseCache, PhenologyVisualParams,
};

pub use crate::worldgen::constants::SEASON_TRANSITION_TICKS;

/// Ancla fenología (EA8) si el elemento estable de `frequency_hz` define `phenology` en almanaque.
